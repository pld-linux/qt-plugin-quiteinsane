...
wtyczki, którą można łatwo zintegrować w aplikację opartą na Qt.
"Łatwo" w tym kontekście oznacza nie więcej niż skopiowanie kilku
linii kodu i uczynienie paru małych modyfikacji. Nie trzeba nic
wiedzieć o bibliotece SANE ani jej API.
